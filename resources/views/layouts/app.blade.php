...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="/">
                    <img src="https://doggishop.live/Logo.png" alt="DOGGISHOP Logo" class="d-inline-block align-top"
                        loading="lazy">
                </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @if (Auth::user()->role == 'guest')
                                        <li class="nav-item">
                                            <a class="nav-link"
                                                href="{{ route('home.showCart', Auth::user()->id) }}">Mis compras</a>
                                        </li>
                                    @endif
                                    <li class="nav-item">
    ...
    <div class="row">
        ...
        @endif
        <div
            class="col container py-2 px-0 mr-0 ml-4 @if (Auth::user()) @if (Auth::user()->role == 'admin' || Auth::user()->role == 'user') col-md-10 @endif @endif">
            <main role="main">
                @yield('content')
            </main>
